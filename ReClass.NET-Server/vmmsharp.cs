...
namespace ReClassNET_Server
{
    ...
    public static class lc
    {
        ...
        {
            IntPtr pLcErrorInfo;
            int cbERROR_INFO = Marshal.SizeOf(typeof(lci.LC_CONFIG_ERRORINFO));
    ...
    public class Vmm : IDisposable
    {
        ...
        {
            hVMM = Initialize(out ConfigErrorInfo, args);
        }

        public Vmm(params string[] args)
        {
            lc.CONFIG_ERRORINFO ErrorInfo;
            hVMM = Initialize(out ErrorInfo, args);
        }
        ...
        {
            bool result;
            ulong cbENTRY = (ulong)Marshal.SizeOf(typeof(vmmi.VMMDLL_PROCESS_INFORMATION));
...
#pragma warning restore CS0168
            uint cbENTRY = (uint)Marshal.SizeOf(typeof(vmmi.VMMDLL_IMAGE_DATA_DIRECTORY));
            fixed (byte* pb = new byte[16 * cbENTRY])
            {
                ...
                for (int i = 0; i < 16; i++)
                {
                    vmmi.VMMDLL_IMAGE_DATA_DIRECTORY n = Marshal.PtrToStructure<vmmi.VMMDLL_IMAGE_DATA_DIRECTORY>((IntPtr)(pb + i * cbENTRY));
        ...
        public unsafe IMAGE_SECTION_HEADER[] ProcessGetSections(uint pid, string wszModule)
        {
            bool result;
            uint cData;
            uint cbENTRY = (uint)Marshal.SizeOf(typeof(vmmi.VMMDLL_IMAGE_SECTION_HEADER));
            ...
            fixed (byte* pb = new byte[cData * cbENTRY])
            {
                ...
                {
                    vmmi.VMMDLL_IMAGE_SECTION_HEADER n = Marshal.PtrToStructure<vmmi.VMMDLL_IMAGE_SECTION_HEADER>((IntPtr)(pb + i * cbENTRY));
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_PTE));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_PTEENTRY));
            ...
            {
                vmmi.VMMDLL_MAP_PTEENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_PTEENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_PTEENTRY e;
                e.vaBase = n.vaBase;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_VAD));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_VADENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_VADENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_VADENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_VADENTRY e;
                e.vaStart = n.vaStart;
                e.vaEnd = n.vaEnd;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_VADEX));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_VADEXENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_VADEXENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_VADEXENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_VADEXENTRY e;
                e.tp = n.tp;
                e.iPML = n.iPML;
                e.va = n.va;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_MODULE));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_MODULEENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_MODULEENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_MODULEENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_MODULEENTRY e;
                e.fValid = true;
                e.vaBase = n.vaBase;
                e.vaEntry = n.vaEntry;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_UNLOADEDMODULE));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_UNLOADEDMODULEENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_UNLOADEDMODULEENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_UNLOADEDMODULEENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
        ...
        public unsafe MAP_EATENTRY[] Map_GetEAT(uint pid, string wszModule, out MAP_EATINFO EatInfo)
        {
            ...
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_EAT));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_EATENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_EATENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_EATENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_EATENTRY e;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_IAT));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_IATENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_IATENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_IATENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_IATENTRY e;
                e.vaFunction = n.vaFunction;
                e.wszFunction = n.wszFunction;
        ...
        {
            IntPtr pMap = IntPtr.Zero;
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_HEAP));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_HEAPENTRY));
            int cbSEGENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_HEAPSEGMENTENTRY));
            MAP_HEAP Heap;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_HEAPENTRY nH = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_HEAPENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_HEAPSEGMENTENTRY nH = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_HEAPSEGMENTENTRY>((IntPtr)(nM.pSegments.ToInt64() + i * cbSEGENTRY));
        ...
        public unsafe MAP_HEAPALLOCENTRY[] Map_GetHeapAlloc(uint pid, ulong vaHeapOrHeapNum)
        {
            ...
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_HEAPALLOC));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_HEAPALLOCENTRY));
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_HEAPALLOCENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_HEAPALLOCENTRY>((IntPtr)(pHeapAllocMap.ToInt64() + cbMAP + i * cbENTRY));
                m[i].va = n.va;
                m[i].cb = n.cb;
                m[i].tp = n.tp;
            }
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_THREAD));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_THREADENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_THREADENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_THREADENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_THREADENTRY e;
                e.dwTID = n.dwTID;
                e.dwPID = n.dwPID;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_HANDLE));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_HANDLEENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_HANDLEENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_HANDLEENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_HANDLEENTRY e;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_NET));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_NETENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_NETENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_NETENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_NETENTRY e;
                e.dwPID = n.dwPID;
                e.dwState = n.dwState;
                e.dwPoolTag = n.dwPoolTag;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_PHYSMEM));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_PHYSMEMENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_PHYSMEMENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_PHYSMEMENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_PHYSMEMENTRY e;
                e.pa = n.pa;
                e.cb = n.cb;
                m[i] = e;
        ...
        public unsafe MAP_POOLENTRY[] Map_GetPool()
        {
            ...
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_POOL));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_POOLENTRY));
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_POOLENTRY nE = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_POOLENTRY>((IntPtr)(pN.ToInt64() + cbMAP + i * cbENTRY));
                eM[i].va = nE.va;
                eM[i].cb = nE.cb;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_USER));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_USERENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_USERENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_USERENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_USERENTRY e;
                e.szSID = n.wszSID;
                e.wszText = n.wszText;
        ...
        {
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_SERVICE));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_SERVICEENTRY));
            IntPtr pMap = IntPtr.Zero;
            ...
            for (int i = 0; i < nM.cMap; i++)
            {
                vmmi.VMMDLL_MAP_SERVICEENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_SERVICEENTRY>((IntPtr)(pMap.ToInt64() + cbMAP + i * cbENTRY));
                MAP_SERVICEENTRY e;
                e.vaObj = n.vaObj;
                e.dwPID = n.dwPID;
                e.dwOrdinal = n.dwOrdinal;
        ...
        public unsafe MAP_PFNENTRY[] Map_GetPfn(params uint[] pfns)
        {
            bool result;
            uint cbPfns;
            int cbMAP = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_PFN));
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_MAP_PFNENTRY));
            ...
            fixed (byte* pbPfns = dataPfns)
            {
                ...
                fixed (byte* pb = new byte[cbPfns])
                {
                    ...
                    {
                        vmmi.VMMDLL_MAP_PFNENTRY n = Marshal.PtrToStructure<vmmi.VMMDLL_MAP_PFNENTRY>((IntPtr)(pb + cbMAP + i * cbENTRY));
        ...
        public unsafe REGISTRY_HIVE_INFORMATION[] RegHiveList()
        {
            bool result;
            uint cHives;
            int cbENTRY = Marshal.SizeOf(typeof(vmmi.VMMDLL_REGISTRY_HIVE_INFORMATION));
            ...
            fixed (byte* pb = new byte[cHives * cbENTRY])
            {
                ...
                {
                    vmmi.VMMDLL_REGISTRY_HIVE_INFORMATION n = Marshal.PtrToStructure<vmmi.VMMDLL_REGISTRY_HIVE_INFORMATION>((IntPtr)(pb + i * cbENTRY));
    ...
    internal static class vmmi
    {
        ...
        internal struct VMMDLL_MEM_SEARCH_CONTEXT
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, ArraySubType = UnmanagedType.Struct, SizeConst = 16)] internal VMMDLL_MEM_SEARCH_CONTEXT_SEARCHENTRY[] search;
